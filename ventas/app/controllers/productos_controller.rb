class ProductosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @producto.save
        format.html { redirect_to @producto, notice: 'Se ha guardao correctamente el producto' }
  ...
  def update
    ...
    respond_to do |format|
      if @producto.update_attributes(params[:producto])
        format.html { redirect_to @producto, notice: 'Se ha Actualizado correctamente el producto' }
