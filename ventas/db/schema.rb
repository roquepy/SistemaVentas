...
ActiveRecord::Schema.define(:version => 20130730075157) do
  ...
  add_index "detalles_movimientos_stocks", ["id_movimiento_stock"], :name => "detalles_movimientos_stocks_id_movimiento_stock_fk"
  add_index "detalles_movimientos_stocks", ["id_stock"], :name => "detalles_movimientos_stocks_id_stock_fk"

  create_table "detalles_movimientos_stocks_auxs", :force => true do |t|
    t.integer "id_stock", :null => false
    t.integer "cantidad", :null => false
  end
  ...
  create_table "movimientos_stocks", :force => true do |t|
    t.date    "fecha",              :null => false
  ...
  add_index "movimientos_stocks", ["id_funcionario"], :name => "movimientos_stocks_id_funcionario_fk"
  add_index "movimientos_stocks", ["id_tipo_movimiento"], :name => "movimientos_stocks_id_tipo_movimiento_fk"
  ...
  add_index "roles_usuarios", ["id_rol"], :name => "roles_usuarios_id_rol_fk"
  add_index "roles_usuarios", ["id_usuario"], :name => "roles_usuarios_id_usuario_fk"
  ...
  add_foreign_key "detalles_movimientos_stocks", "movimientos_stocks", :name => "detalles_movimientos_stocks_id_movimiento_stock_fk", :column => "id_movimiento_stock"
  add_foreign_key "detalles_movimientos_stocks", "stock", :name => "detalles_movimientos_stocks_id_stock_fk", :column => "id_stock"
  ...
  add_foreign_key "movimientos_stocks", "funcionarios", :name => "movimientos_stocks_id_funcionario_fk", :column => "id_funcionario"
  add_foreign_key "movimientos_stocks", "tipos_movimientos", :name => "movimientos_stocks_id_tipo_movimiento_fk", :column => "id_tipo_movimiento"

  add_foreign_key "roles_usuarios", "roles", :name => "roles_usuarios_id_rol_fk", :column => "id_rol"
  add_foreign_key "roles_usuarios", "users", :name => "roles_usuarios_id_usuario_fk", :column => "id_usuario"
